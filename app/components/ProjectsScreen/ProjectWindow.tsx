                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-10 py-11 bg-gradient-to-b from-blue-500 to-blue-700 flex items-center justify-between px-5 md:px-10 relative">
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    <div className="flex text-white flex-col">
                                        <span className="font-bold text-xl">Project 1</span>
                                        <span className="font-light text-sm">5 Tasks</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="absolute right-12 top-[22px]">
                                <div className="relative">
                                    ...
                                    <div className="absolute top-[34px] left-[27px] flex flex-col justify-center items-center">
                                        <span className="text-[8px] font-light text-white">Completed</span>
                                        <span className="text-[16px] font-light text-white">{data[0].value}%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <FontAwesomeIcon 
                                    onClick={() => setopenCreatedProjectBox(false)}
                                    className="text-white top-4 right-4 opacity-80 absolute"
                                    icon={faClose}
                                />
                            </div>
                        </div>
