...
export default function CaregoriesTopBar(){
    ...
    return(
        <div className={`p-8 pt-12 flex justify-between ${
            isdark? "bg-gray-900":"bg-white"
        }`} >
            <div className="flex gap-7 items-center">
                <span className="flex flex-col"> 
                    <span className="font-bold text-2xl "> Categories</span>
                    <p className="text-[12px] font-light">3 Categories</p>
                </span>
                <button className="bg-blue-500 flex gap-1 items-center p-2 px-4 text-white rounded-md cursor-pointer active:scale-95">
                    <FontAwesomeIcon
                    icon={faPlus}
                    className="font-bold"
                    />
